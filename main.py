...
def main_screen():
    ...
    Label(text="Enter text to be encrypted or decrypted",fg="black",font=("Calibri",13)).place(x=10,y=10)
    ...
    Button(text="RESET",height="2",width=50,bg="#1089ff",bd=0,command=reset).place(x=10,y=300)
    screen.mainloop()
main_screen()